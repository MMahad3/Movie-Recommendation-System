...
def fetch_data(movie_id):
    response = requests.get(f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=c1a0fd94adf3e2100677929be4361d07&language=en-US")
...
#select box of webpage
	option = st.selectbox(
		'Select the movie to generate recommendations',
		movie["title"].values)
...
with st.container():
	...
	contact_form="""<form action="https://formsubmit.co/mahadmunir6@gmail.com" method="POST">
...
with st.container():
	...
	with col1:
		st.write("2025 © Movie-Recommendation System | All Rights Reserved.")
	with col3:
